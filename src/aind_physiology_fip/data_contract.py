            ...
            DataStreamCollection(
                ...
                data_streams=[
                    SoftwareEvents(
                        ...
                        reader_params=SoftwareEvents.make_params(path=root / "SoftwareEvents/StartSessionTime.json"),
                    ),
                    SoftwareEvents(
                        name="EndSessionTime",
                        description="An event emitted at the end of the session. Data contains a UTC timestamp of the session end time.",
                        reader_params=SoftwareEvents.make_params(path=root / "SoftwareEvents/EndSessionTime.json"),
                    ),
                    SoftwareEvents(
                        name="Annotations",
                    ...
                    SoftwareEvents(
                        name="Regions",
                        description="An event emitted whenever a new region is defined during the session.",
                        reader_params=SoftwareEvents.make_params(path=root / "SoftwareEvents/Regions.json"),
                    ),
                    SoftwareEvents(
                        name="HardwareQA",
