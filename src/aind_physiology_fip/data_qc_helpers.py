...
def plot_sensor_floor(background_ch: ArrayLike, channel: str) -> matplotlib.figure.Figure:
    """
    ...
    _make_hist(
        background_ch, ax[0, 0], ax[1, 0], channel_colors.get(channel, "black"), f"{channel.capitalize()} Channel"
    )
